    ...
    <section className="min-h-screen pt-12">
      <div className="container mx-auto">
        <Fade direction="up" delay={400} cascade damping={1e-1} triggerOnce={true}>
          <h2 className="section-title mb-8 xl:mb-16 text-center mx-auto">My Pricing</h2>
        </Fade>
        ...
        <Fade direction="up" delay={1000} cascade damping={1e-1} triggerOnce={true}>
          <div className="mx-auto mt-16 max-w-2xl ring-1 ring-gary-200 rounded-3xl sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            {/* Left Section */}
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <ul
                role="list"
                className="mt-8 grid grid-clos-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6"
              >
              ...
              <div className="bg-tertiary py-10 rounded-2xl text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                <div className="mx-auto max-w-xs px-8">
                  ...
                  <p className="mt-6 text-xs leading-5">
                    Invoice and receipts available for easy company reimbursement
                  </p>
                </div>
              </div>
            </div>

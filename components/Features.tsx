...
const features = [
  {
    name: "PHOTOGRAPHY",
    description:
      "Studio comes with elements made specifically for photographer, including the client list, password protected pages, and the proofing gallery",
  ...
  },
  {
    ...
    description:
      "It is fully flexible theme. All elements, pages and every other aspect of your website can be effortlessly adapted to fit your specific needs",
    icon: ArrowPathIcon,
  },
  {
    name: "FREE PLUGINS",
    ...
    <section className="pb-12 xl:py-24">
      <div className="container mx-auto">
        <Fade direction="up" delay={400} cascade damping={1e-1} triggerOnce={true}>
          <h2 className="section-title mb-2 xl:mb-3 text-center mx-auto">Key Feature</h2>
        </Fade>

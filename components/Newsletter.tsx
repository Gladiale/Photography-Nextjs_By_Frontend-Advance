            ...
            <div className="max-w-xl lg:max-w-lg">
              ...
              <Fade direction="left" delay={600} cascade damping={1e-1} triggerOnce={true}>
                <p className="mt-4 text-lg leading-8 subtitle">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae eum reiciendis
                  unde magni delectus cupiditate inventore autem, architecto excepturi, nisi ab
                  velit. Libero non corporis, temporibus iusto odio nulla voluptatum!
                </p>
              </Fade>
